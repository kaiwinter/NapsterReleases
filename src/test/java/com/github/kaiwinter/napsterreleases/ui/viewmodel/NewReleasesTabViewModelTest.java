...
public final class NewReleasesTabViewModelTest {
   ...
   /**
    * Loads the genres and tests if the genre list contains the loaded genres. The genre list should contain 3 genres.
    * One loaded from the wrapper and two synthetically created.
    */
   @Test
